...
<script type="text/javascript" language="javascript" src="../js/funcionesdescarga.js"></script>
...
<link href="../css/demo_tablebuscar.css" rel="stylesheet" type="text/css" />
	  ...
	  document.getElementById('div3').style.backgroundColor="#f3f781";
	  document.getElementById("div3").innerHTML="MÓDULO DE DESCARGA";	  	  
      </script> 
...
<div class="videodescarga"> <!--DIV QUE REPRODUCE EL VIDEO-->
 <?php
	clearstatcache(); 
	require("../libs/buscaiddescarga.php");
...
<div class="datosdescarga">

     <form id="form1" name="form1" method="post" action="../libs/descargavideo.php">
         <table class="tabladatos">                 
              ...
              <label for="id" style="font-weight:bold;">ID:</label>                             
                ...
                <input name="videos" type="text"  readonly="readonly" id="videos" size="15"  maxlength="10" value="<?php if(isset ($videos)) echo $videos; else echo ""; ?>"> 
                 ...
                 <input name="codigo_bar" type="text" readonly="readonly"  id="codigo_bar" value="<?php if(isset ($codigo_bar)) echo $codigo_bar; else echo ""; ?>" size="12" maxlength="12"/></td>
                 ...
                 <table  class="tabladatos">
                     ...
                     <tr>
                     <td>Sinopsis:</td>
                     <td><input type="text" name="sinopsis" readonly="readonly"  cols="50" value="<?php if(isset ($sinopsis)) echo $sinopsis; else echo ""; ?>" rows="1" style="width:440px; height:26px;" id="sinopsis" ></td>
                     </tr>
                     <tr>
                     <td>Serie:</td>
                     ...
                     <tr>
                     <td>Creditos:</td>
                     <td><input name="creditos" cols="54" rows="1" readonly="readonly" value="<?php if(isset ($creditos)) echo $creditos; else echo ""; ?>" id="creditos" style="width:440px; height:26px;"></td>
                     </tr>
                     <tr>
                     <td>Institución poseedora:</td>
                     <td><input value="<?php if(isset ($inst_posee)) echo $inst_posee; else echo ""; ?>" name="inst_posee" cols="54" rows="1" id="inst_posee" readonly="readonly" style="width:440px; height:26px;"></td>
                     </tr>
                     
                        <tr>
                            <td>Carac. de vídeo:</p></td>
                            <td>
                              <input name="carac_video" readonly="readonly" value="<?php if(isset ($carac_video)) echo $carac_video; else echo ""; ?>" cols="54" rows="2" style="width:440px; height:26px;"></td>
                        </tr>
                        <tr>
                            <td>Carac. del sonido:</td>
                            <td><input name="carac_sonido"  readonly="readonly" value="<?php if(isset ($carac_sonido)) echo $carac_sonido; else echo ""; ?>" cols="54" style="width:440px; height:26px;" rows="2" id="carac_sonido"></td>
                        </tr>
                        <tr>
                            <td>Institución productora:</td>
                            <td><input name="inst_prod" readonly="readonly"  cols="54" value="<?php if(isset ($inst_prod)) echo $inst_prod; else echo ""; ?>" style="width:440px; height:26px;" rows="1" id="inst_prod"></td>
                        </tr>
                        <tr>
                            <td>Disponibilidad:</td>
                            <td><input name="disponibilidad" readonly="readonly"  value="<?php if(isset ($disponibilidad)) echo $disponibilidad; else echo ""; ?>" cols="54" style="width:440px; height:26px;" rows="1" id="disponibilidad"></td>
                        </tr>
                        <tr>
                            <td>Programa de origen:</td>
                            <td><input name="progra_origen" readonly="readonly" value="<?php if(isset ($progra_origen)) echo $progra_origen; else echo ""; ?>" cols="54" style="width:440px; height:26px;" rows="2" id="progra_origen"></td>
                        </tr>
                        <tr>
                            <td>Lugar de la institución:</td>
                            <td><input value="<?php if(isset ($lugar_inst)) echo $lugar_inst; else echo ""; ?>" name="lugar_inst" cols="54" style="width:440px; height:26px;" readonly="readonly"  rows="2" id="lugar_inst"></td>
                        </tr>
                    <tr>
                   
                    <td></td>
                    <td align="right"><input  type="submit" name="button" id="button" value="Descarga" class="enviar" onclick="<?php ?>"/>
                    </tr>                                                   
                    </table>                                       
