...
?>
<form id="form2" name="form2" method="post" action="../libs/buscaidelimina.php">
    <table class="tablaIDElimina">                 
    <tr> 
    <td>Escriba el ID a eliminar</td>    
    </tr>
    <tr>
    <td><input name="id" autofocus="autofocus" type="text" value="<?php if (isset($_POST['id'])){ echo $_POST['id']; } ?>" /></td>
    </tr>
    <tr>
    <td align="right"><input type="submit" name="button" id="button" value="Buscar" class="enviar"/>
    </tr>                                                   
    </table>                                       
...
<div class="videoelimina"> <!--DIV QUE REPRODUCE EL VIDEO-->
 <?php
	...
	$videos1 = '../terminados/'.$_GET["videos"].$_GET['formato'];	
//	$videos1 = '../terminados/'.$_GET["videos"].'.mov';		
?>
...
<div class="datoselimina">
     ...
     <form id="form1" name="form1" method="post" action="../libs/qryelimina.php">
         <table class="tabladatos">                 
                 <tr>
              <label for="id" style="font-weight:bold;">ID VIDEO CATALOGADO:</label>                             
                <label id="id1">
